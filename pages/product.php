...
?>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5">
        ...
        <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="404.php" class="nav-item nav-link">Services</a>
                <a href="product.php" class="nav-item nav-link active">Products</a>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                    <div class="dropdown-menu bg-light m-0">
                        <a href="404.php" class="dropdown-item">Gallery</a>
                        <a href="404.php" class="dropdown-item">Features</a>
                        <a href="404.php" class="dropdown-item">Our Team</a>
    ...
    <div class="container">
        ...
        <div class="row gx-4">
            ...
            while ($row = $product_result->fetch_assoc()) { 
                echo '
                <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.7s" style="margin-bottom: 20px;">
                    <div class="product-item">
                        ...
                        <div class="text-center p-4">
                            <a class="d-block h5" href="">' . $row['product_name'] . '</a>
